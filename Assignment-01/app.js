// JavaScript Chapter:01 Assginment
...
// Ans1.
//  console.log(4+10);
//  In console.log the response I get is 14.
...
// Ans2.
//  console.log("Jaweria Ahmed Siddiqui");
...
// Ans2.
// let a = 10; // Set the value of a is 10
...
// Example1
// let a = 10;
// console.log("The value of a is " + a); // console.log display the value of variable a.

// Example2
// console.log("jiya") // here console.log shows my nick name.
...
/* In this code i set a variable nam assgin my real name jaweria in string bcz this is not a number so i used this in a string & print console.log hello my name is nam (i already assgin the variable name before which is jaweria so in console.log variable nam print jaweria)*/
...
/* In this code i set a variable which i assgin a value 50 & this is a number (50) so we donot write it in a string & in next line print it to a console the value of x is 50*/
